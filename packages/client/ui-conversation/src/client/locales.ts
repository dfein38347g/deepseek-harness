...
export const zh = {
  ...
  'search.matches.capped': '显示 {shown} / 共 {total} 处匹配 · {files} 个文件',
  'search.paths': '{shown} 个路径',
  'search.paths.capped': '显示 {shown} / 共 {total} 个路径',
  'search.empty': '无结果',
...
export const en = {
  ...
  'search.matches.capped': 'showing {shown} of {total} matches · {files} files',
  'search.paths': '{shown} paths',
  'search.paths.capped': 'showing {shown} of {total} paths',
  ...
  'read.windowed': 'showing {shown} of {total} lines',
