...
export const zh = {
  ...
  'message.rollback': '回滚到此消息',
  'message.rollbackUnavailable': '仅可在会话空闲时回滚',
...
export const en = {
  ...
  'message.rollback': 'Roll back to this message',
  'message.rollbackUnavailable': 'Available only while the session is idle',
